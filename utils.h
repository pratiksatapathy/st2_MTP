...
//#define MME "10.129.28.45" //for other parallel replicas
//#define MME "10.129.28.29" //for other parallel replicas

#define SGW "10.129.28.191"
//#define SGW "10.129.28.224" //for other parallel replicas
//#define SGW "10.129.26.140" //for other parallel replicas

#define PGW "10.129.28.147"
//#define PGW "10.129.26.101" //for other parallel replicas
//#define PGW "10.129.26.148" //for other parallel replicas

#define MMELB "10.129.28.175"
#define SGWLB "10.129.28.180"
#define PGWLB "10.129.28.51"
...
//#define INIT_VAL 700000000   // to set with different init value for other mme replicas e.g. next replica could start with 700000000
